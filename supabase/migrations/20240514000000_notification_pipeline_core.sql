...
VALUES
  ('Critical SOS Alerts', 'sos_triggered', 'sos', 'critical', ARRAY['family', 'healthpro'], ARRAY['push', 'sms', 'in-app'], true, 100),
  ('Vital Signs Anomalies', 'vital_anomaly', 'vitals', 'warning', ARRAY['healthpro'], ARRAY['push', 'in-app'], false, 200),
  ('Missed Medication Alerts', 'medication_missed', 'medication', 'warning', ARRAY['family', 'healthpro'], ARRAY['push', 'in-app'], false, 300),
  ('Emotion State Changes', 'emotion_change', 'emotion', 'info', ARRAY['family'], ARRAY['in-app'], false, 400); 